  ...
  subsections: [
    {
      ...
      formulas: [
        ...
        },
        {
          ...
          keywords: ["together", "adjacent", "glue", "gap method", "not adjacent"],
          importance: "high",
          level: ["MATHCOUNTS", "AMC10"]
        },
        {
    ...
    },
    {
      ...
      formulas: [
        ...
        },
        {
          ...
          name: "Weighted Binomial Sums ($k$ and $k^2$)",
    ...
    },
    {
      ...
      formulas: [
        ...
        },
        {
          ...
          name: "Balls-in-Boxes Overview (Twelvefold Way)",
          ...
          keywords: ["twelvefold", "distinguishable", "indistinguishable", "distribute cases"],
          importance: "medium",
          level: ["AMC12", "AIME"]
        }
      ]
    },
    {
      ...
      formulas: [
        ...
        {
          id: "losing-positions",
          name: "Game Analysis: Losing Positions",
          type: "method",
          ...
          keywords: ["game", "nim", "p positions", "winning strategy", "periodic pattern", "take away", "method"],
          importance: "medium",
          level: ["AMC10", "AMC12", "AIME"]
        },
        {
        ...
        {
          id: "stirling-bell",
          name: "Stirling (2nd Kind) & Bell Numbers",
        ...
        },
        {
          ...
          name: "Recursive / State Counting (Tilings)",
          ...
          keywords: ["tilings", "recursion", "no two adjacent", "binary strings", "states"],
          importance: "medium",
          level: ["AMC10", "AMC12", "AIME"]
        },
        {
        ...
        {
          id: "surjections",
          name: "Counting Surjections (Onto Functions)",
          ...
          keywords: ["onto", "surjective", "every box nonempty", "inclusion exclusion functions"],
          importance: "medium",
          level: ["AIME"]
        },
        {
          id: "stirling-first-kind",
          name: "Stirling Numbers of the First Kind (Cycles)",
    ...
    },
    {
      ...
      formulas: [
        ...
        {
          id: "hypergeometric",
          name: "Drawing Without Replacement (Hypergeometric)",
          ...
          keywords: ["without replacement", "exactly k", "cards", "balls from urn"],
          importance: "medium",
          level: ["AMC10", "AMC12", "AIME"]
        },
        {
        ...
        },
        {
          ...
          latex: String.raw`E[\max] = \frac{n}{n+1}, \qquad E[\min] = \frac{1}{n+1}, \qquad E[\text{gap}] = \frac{1}{n+1}, \qquad P(\max \le x) = x^n, \qquad E[\max - \min] = \frac{n - 1}{n + 1}`,
        ...
        },
        {
          ...
          name: "Law of Total Expectation (Tower Rule)",
        ...
        {
          id: "gamblers-ruin",
          name: "Gambler's Ruin (Fair and Biased)",
    ...
    },
    {
      ...
      formulas: [
        ...
        {
          id: "double-counting",
          name: "Double Counting (Committee Counting)",
          ...
          keywords: ["count two ways", "incidence", "tournament", "rows columns"],
          importance: "medium",
          level: ["AIME", "Olympiad"]
        },
        {
    ...
    },
    {
      ...
      formulas: [
        {
          id: "cayleys-formula",
          name: "Cayley's Formula (Labeled Trees)",
        ...
        {
          id: "plane-regions",
          name: "Regions from Lines and Circles (Lazy Caterer)",
    ...
    },
    {
      ...
      formulas: [
        ...
        {
          id: "bijection-method",
          name: "Bijections: Count Something Easier",
          type: "method",
        ...
        },
        {
          ...
          name: "Recursive Counting (Build Up by Last Step)",
          type: "method",
          ...
          keywords: ["recursion", "count by last step", "state counting", "build up", "strings avoiding pattern", "method"],
          importance: "medium",
          level: ["AMC10", "AMC12", "AIME"]
        },
        {
